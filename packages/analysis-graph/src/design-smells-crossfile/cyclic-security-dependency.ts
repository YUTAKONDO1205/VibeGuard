...
function isTypeOnlyImport(lineText: string): boolean {
...
function importsOnlyTypes(edge: ImportEdge, target: StructureIndex, cache: Map<string, ExportKinds>): boolean {
